...
var controller = {
    ...
    updateProject: function(req, res){
        ...
        Project.findByIdAndUpdate(projectId, update,{new:true}, (err, projectUpdated) => {
            ...
            if(!projectUpdated) return res.status(404).send({message:'No hay ningun proyecto con ese ID'});
    ...
    deleteProject: function(req, res){
        ...
        Project.findByIdAndDelete(projectId, (err, projectDeleted) => {
            ...
            if(!projectDeleted) return res.status(404).send({message:'No hay ningun proyecto a eliminar con ese ID'});
